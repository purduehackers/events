...
const DialogDemo = ({
	...
	>
		...
		<Dialog.Portal>
			<Dialog.Overlay className="z-400 fixed inset-0 bg-zinc-900/60 data-[state=open]:animate-[overlay-in_180ms_var(--ease-snappy)]" />
			<Dialog.Content className="z-450 bg-black px-10 py-8 border-1 border-zinc-800 fixed left-1/2 top-1/2 w-[90vw] max-w-[430px] h-fit max-h-[80vh] -translate-x-1/2 -translate-y-1/2 focus:outline-none data-[state=open]:animate-[modal-in_200ms_var(--ease-snappy)]">
