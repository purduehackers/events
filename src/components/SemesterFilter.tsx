...
export default function SemesterFilter({ semesters, triggerStyle, portalStyle, itemStyle }: SemesterFilterProps) {
  ...
  return (
    <Selector
      ...
      triggerStyle={triggerStyle? triggerStyle : "w-36 px-2 py-1 items-center justify-between gap-1 font-pixel uppercase text-[15px] leading-none text-gray-900 dark:text-gray-100 data-[placeholder]:bg-transparent data-[placeholder]:text-gray-400"}
      ...
      itemStyle={itemStyle? itemStyle : "relative select-none flex items-center rounded-none py-2 px-6 text-[15px] leading-none text-gray-900 dark:text-gray-100 data-[highlighted]:bg-purple-400 data-[highlighted]:text-white data-[highlighted]:outline-none data-[disabled]:pointer-events-none data-[disabled]:text-gray-500"}
    />
  );
}
