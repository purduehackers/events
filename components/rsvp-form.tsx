...
const RSVPForm = ({ eventName, slug }: { eventName: string, slug: string }) => {
  ...
  return (
    <div className="flex flex-col items-left mt-6">
      ...
      <form onSubmit={onSubmit} className="flex flex-col xs:flex-row items-left gap-y-2 xs:gap-x-2 mb-1">
        ...
        <button type="submit" className="bg-yellow-400 dark:bg-yellow-500 rounded-md shadow-md py-2 xs:px-2 font-bold hover:scale-105 transform transition
