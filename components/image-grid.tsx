  ...
  return (
    <div className="flex flex-col gap-y-4 mx-4 sm:mx-0 items-center">
      <div className="grid grid-cols-2 gap-2 md:grid-cols-3 md:gap-x-2 sm:max-w-lg md:max-w-xl items-center">
        ...
        <button
          className="sm:hidden rounded-lg mx-auto py-2 px-2 font-bold text-l dark:text-gray-200 shadow-md dark:shadow-black/25 border-solid border-2 border-amber-400 dark:border-amber-500 p-2 px-4 text-center hover:scale-105 transform transition"
          onClick={(e) => {
            if (!e.metaKey) {
              e.preventDefault()
              setIndex(0)
